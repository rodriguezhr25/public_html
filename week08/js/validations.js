...
function validateFirstName() {
    if (first_name.value == "" || typeof (first_name) == 'undefined') { //
        ...
        /*         var para = document.createElement("p");
                ...
                var element = document.getElementById("f_name");
                element.appendChild(para); */
        let message = document.getElementById("first_name_output");
        if (message) {
            message.remove();
        }
        var p = document.createElement("p");
        var node = document.createTextNode("Register the first name");
        p.appendChild(node);
        p.setAttribute("id", "first_name_output")
        ...
        let message = document.getElementById("first_name_output");
        if (message) {
            document.getElementById('first_name_output').innerText = "";
        }
...
function validateLastName() {
    if (last_name.value == "" || typeof (last_name) == 'undefined') { //
        ...
        let message = document.getElementById("last_name_output");
        if (message) {
            message.remove();
        }
        var p = document.createElement("p");
        var node = document.createTextNode("Register the last name");
        p.appendChild(node);
        p.setAttribute("id", "last_name_output")
        p.classList.add("p-invalid");
        var element = document.getElementById("l_name");
        element.appendChild(p);
        validateButton.disabled = true;
        ...
        let message = document.getElementById("last_name_output");
        if (message) {
            document.getElementById('last_name_output').innerText = "";
        }
